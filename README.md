...
Welcome to AndroidLiveStreaming, a good component for Android live-Streaming. This is a pure
java language project, and doesn't depend on any other library. Fork from [SopCastComponent](https://github.com/LaiFeng-Android/SopCastComponent) , But the writer have nothing update for more than twe years, I create this new repositories for study except business.
